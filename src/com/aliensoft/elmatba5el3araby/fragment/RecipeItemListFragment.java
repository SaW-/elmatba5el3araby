package com.aliensoft.elmatba5el3araby.fragment;
...
import com.aliensoft.elmatba5el3araby.content.SearchWithRecipeRecord;
...
import com.aliensoft.elmatba5el3araby.util.ViewUtils;
...
public class RecipeItemListFragment extends ListFragment implements LoaderCallbacks<Cursor>,
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		query += "GROUP BY _id";
		CursorLoader createSupportLoader = newQuery.append(query).createSupportLoader(
				SearchWithRecipe.CONTENT_URI, SearchWithRecipeRecord.PROJECTION,
				SearchWithRecipe.NAME + " ASC");
